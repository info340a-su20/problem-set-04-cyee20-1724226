...
let n = Boolean(motto.indexOf("cool") != -1);
console.log(n);
...
let medianIndex = (sortArray.length) / 2 - 0.5;
let median = sortArray[medianIndex];
console.log(median);
...
let circle = {
    cx: 34,
    cy: 43,
    radius: sortArray[sortArray.length - 1]
};
console.log(circle);
...
shapes[2] = {base: 33, height: 44, hypotenuse: 55};
console.log(shapes);